#!/bin/sh
mvn install:install-file -Dfile=aniways-V1.76.jar -DgroupId=com.aniways -DartifactId=library -Dversion=1.76 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
